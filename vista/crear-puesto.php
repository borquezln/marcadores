...
<body>
    ...
    <main>
        <form enctype="multipart/form-data" action="../controlador/crear-form.php" method="POST">
            <div>
                <input type="hidden" name="marcador" value="puestos">

                <label for="direccion">
                    Dirección del puesto: <input name="direccion" value="" required>
                </label>
                <br>
                ...
                <label for="latitud">
                    Latitud:
                    <textarea id="latitudTextarea" name="latitud" rows="1" readonly></textarea>
                </label>
                <br>
                <label for="longitud">
                    Longitud:
                    <textarea id="longitudTextarea" name="longitud" rows="1" readonly></textarea>
                </label>
                <br>
                <label for="foto">
                    Foto:
